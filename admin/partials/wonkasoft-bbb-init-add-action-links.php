 ...
 */
function wonkasoft_bbb_init_add_settings_link_filter( $links ) {
	global $wonkasoft_bbb_init_page;
	$links_addon = '<a href="' . menu_page_url( $wonkasoft_bbb_init_page, 0 ) . '" target="_self">Settings</a>';
 ...
 * @return array        returns a modified array of the links.
 */
function wonkasoft_bbb_init_add_description_link_filter( $links, $file ) {
	global $wonkasoft_bbb_init_page;
	if ( strpos( $file, 'wonkasoft-bbb-integration.php' ) !== false ) {
		$links[] = '<a href="' . menu_page_url( $wonkasoft_bbb_init_page, 0 ) . '" target="_self">Settings</a>';
